import * as RoomManager from './components/room/manager';
...
import './prototypes/StructureSpawn.prototype';

// This is an example for using a config variable from `index.ts`.
